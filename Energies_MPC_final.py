...
def calculation_plot(calc):
    ...
    plt.legend(fontsize=20)  # Increase legend font size to 15
    plt.grid(True)
    plt.savefig("calculation_time_comparison.png", dpi=1200)
    plt.show()
...
def combined_econ_plot(econ_mpc, econ_no_mpc):
    ...
    #plt.title('Economic Impact Comparison')
    plt.xlabel('Time', fontsize = 15)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("economic_impact_comparison.png", dpi=1200)
    plt.show()
...
def combined_enviro_plot(enviro_mpc, enviro_no_mpc):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("environmental_impact_comparison.png", dpi=1200)
    plt.show()
...
def excess_power_plot(excess_mpc, excess_no_mpc):
    ...
    #plt.title('Excess Power Produced Comparison')
    plt.xlabel('Time', fontsize = 15)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("excess_power_comparison.png", dpi=1200)
    plt.show()
...
def total_cost_plot(cost_mpc, cost_no_mpc):
    ...
    #plt.title('Total Cost Over Time Comparison')
    plt.xlabel('Time', fontsize = 15)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("total_cost_comparison.png", dpi=1200)
    plt.show()
...
def total_emissions_plot(emission_mpc, emission_no_mpc):
    ...
    #plt.title('Total Emissions Over Time Comparison')
    plt.xlabel('Time', fontsize = 15)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("total_emissions_comparison.png", dpi=1200)
    plt.show()
...
def fitness_evolution_plot(fitness_mpc, fitness_no_mpc):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("fitness_evolution_comparison.png", dpi=1200)
    plt.show()
...
def power_plot(power, load, title_suffix=''):
    ...
    #plt.title(f'Power and Load {title_suffix}')
    plt.xlabel('Time', fontsize=15)
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f"power_load_comparison_{title_suffix.strip('()').lower().replace(' ', '_')}.png", dpi=1200)
    plt.show()
